...
const _sfc_main = {
  ...
  created() {
    this.cale = new common_vendor.Calendar({
    ...
    init(date) {
      ...
      if (!date) {
        ...
        if (this.defaultValue && !this.range) {
          ...
          const fullDate = common_vendor.getDate(defaultDate);
          ...
          this.time = common_vendor.getTime(defaultDate, this.hideSecond);
        }
      }
    },
    /**
    ...
    setEmit(name) {
      if (!this.range) {
        ...
        if (this.hasTime && !this.time) {
          this.time = common_vendor.getTime(/* @__PURE__ */ new Date(), this.hideSecond);
        }
      }
      let {
        year,
