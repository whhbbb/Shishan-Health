  ...
  methods: {
    ...
    async chooseFileCallback(res) {
      ...
      let {
        filePaths,
        files
      } = common_vendor.get_files_and_is_max(res, _extname);
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        let filedata = await common_vendor.get_file_data(files[i], this.fileMediatype);
        filedata.progress = 0;
    ...
    uploadFiles(files) {
      files = [].concat(files);
      return common_vendor.uploadCloudFiles.call(this, files, 5, (res) => {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/whhbbb/Documents/Project-storage/xswc_game/node_modules/@dcloudio/uni-ui/lib/uni-file-picker/uni-file-picker.vue"]]);
wx.createComponent(Component);
//# sourceMappingURL=uni-file-picker.js.map
