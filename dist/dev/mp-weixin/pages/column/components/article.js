  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        d: common_vendor.t(item.value.viewsNums),
        e: !item.value.tblLike
      }, !item.value.tblLike ? {
        f: common_vendor.o(($event) => likeUp(item.value.id, item.value.tblLike))
      } : {
        g: common_vendor.o(($event) => likeUp(item.value.id, item.value.tblLike))
      }, {
        h: common_vendor.t(item.value.likeCount)
      });
    };
  }
});
